  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved income as @income" do
        ...
        post :create, {:income => { "amount" => "invalid value" }}, valid_session
        assigns(:income).should be_a_new(Income)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested income" do
        ...
        Income.any_instance.should_receive(:update_attributes).with({ "amount" => "9.99" })
        put :update, {:id => income.to_param, :income => { "amount" => "9.99" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the income as @income" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Income.any_instance.stub(:save).and_return(false)
        put :update, {:id => income.to_param, :income => { "amount" => "invalid value" }}, valid_session
        assigns(:income).should eq(income)
      end
